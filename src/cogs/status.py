...
Handles system metrics, bot health, and performance monitoring.
"""
...
from src.components.decorators.admin_required import admin_required_with_defer
...
class StatusCommands(commands.Cog):
    ...
    async def status_command(
        ...
        try:
            ...
            logger.info(f"[STATUS][CMD] Status command invoked by user {interaction.user.id}, view={view_value}, details={details}, compact={compact}")
    ...
    async def _build_status_embed(
        ...
        telegram_status = "Connected" if hasattr(self.bot, "telegram_client") and self.bot.telegram_client.is_connected() else "Disconnected"
