...
class SimpleConfig:
    ...
    def load(self, profile=None, config_file=None):
        ...
        try:
            ...
            if profile and "profiles" in base_config and profile in base_config["profiles"]:
                self._merge_config(final_config, base_config["profiles"][profile])
    ...
    def create_snapshot(self, name=None):
        ...
        try:
            ...
            logger.info(f"Configuration snapshot created: {snapshot_file}")
            return name
